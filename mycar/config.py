...
VESC_BAUDRATE= 115200 # baudrate for the serial communication. Shouldn't need to change this.
VESC_TIMEOUT= 0.05 # timeout for the serial communication
VESC_STEERING_SCALE= 1 # VESC accepts steering inputs from 0 to 1. Joystick is usually -1 to 1. This changes it to -0.5 to 0.5
VESC_STEERING_OFFSET = 0.5 # VESC accepts steering inputs from 0 to 1. Coupled with above change we move Joystick to 0 to 1
...
OAKD_RGB = True       # True to capture RGB image
OAKD_DEPTH = False     # True to capture depth as image array
OAKD_ID = None        # serial number of camera or None if you only have one camera (it will autodetect)
OAKD_USB_SPEED = 'usb2'
